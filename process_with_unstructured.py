"""
Process all pharmacy formulary PDFs using Unstructured.io

This script processes all PDF files in the data directory using the
Unstructured.io processor, which provides excellent table extraction
capabilities without requiring an API key.
"""
...
def main():
    """Main function to process all PDFs with Unstructured.io"""
    print("=== Process All PDFs with Unstructured.io ===")
    ...
    processor = UnstructuredProcessor(index_name="form")
